...
const set_rotation = () => {
  ...
  cube.style.transform = 'rotateX(' + rotation_data.rotate_x + 'deg) rotateY(' + rotation_data.rotate_y + 'deg) rotateZ(' + rotation_data.rotate_z + 'deg)';
};
...
top_range.addEventListener('input', () => {
  top_element.style.transform = 'translateX(0px) translateY(' + Number(-100 - top_range.value * 20) + 'px) translateZ(0px) rotateX(-90deg) rotateY(0deg) rotateZ(0deg)'; 
});


bottom_range.addEventListener('input', () => {
  bottom_element.style.transform = 'translateX(0px) translateY(' + Number(100 + bottom_range.value * 20) + 'px) translateZ(0px) rotateX(90deg) rotateY(0deg) rotateZ(0deg)'; 
});



front_range.addEventListener('input', () => {
  front_element.style.transform = 'translateX(0px) translateY(0px) translateZ(' + Number(100 + front_range.value * 20) + 'px) rotateX(0deg) rotateY(0deg) rotateZ(0deg)';
});

back_range.addEventListener('input', () => {
  back_element.style.transform = 'translateX(0px) translateY(0px) translateZ(' + Number(-100 - back_range.value * 20) + 'px) rotateX(0deg) rotateY(0deg) rotateZ(0deg)';
});


left_range.addEventListener('input', () => {
  left_element.style.transform = 'translateX(-' + Number(100 + left_range.value * 20) + 'px) translateY(0px) translateZ(0px) rotateX(0deg) rotateY(-90deg) rotateZ(0deg)';
})

right_range.addEventListener('input', () => {
  right_element.style.transform = 'translateX(' + Number(100 + right_range.value * 20) + 'px) translateY(0px) translateZ(0px) rotateX(0deg) rotateY(90deg) rotateZ(0deg)';
});
